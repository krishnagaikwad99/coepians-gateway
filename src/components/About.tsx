...
const About = () => {
  ...
  return <section id="about" className="py-16 lg:py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">At Er. COEPian's Academy, we believe that true learning happens when concepts are understood deeply, not memorized.</p>
          ...
          <div className="space-y-4">
            {features.map((feature, index) => <div key={feature.title} className="group flex gap-4 p-4 bg-card rounded-xl border border-border hover:border-primary/50 hover:shadow-md transition-all duration-300" style={{
