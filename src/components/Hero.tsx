...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 right-10 w-64 h-64 bg-gold/10 rounded-full blur-3xl animate-float" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p
            className="text-xl md:text-3xl lg:text-4xl font-cursive text-gold mb-6 animate-fade-in-up"
            style={{
              animationDelay: "0.4s",
          ...
          {/* Description */}
          <p className="text-base md:text-lg text-primary-foreground/80 max-w-xl mx-auto mb-8 animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center animate-fade-in-up" style={{ animationDelay: "0.8s" }}>
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 px-6 py-5 text-base"
            >
